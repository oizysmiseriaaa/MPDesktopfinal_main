...
describe('stableStringify helper', () => {
    it('stringifies object deterministically by sorting keys', () => {
        const objA = { b: 2, a: 1 };
        const objB = { a: 1, b: 2 };
        expect((0, route_helpers_1.stableStringify)(objA)).toBe((0, route_helpers_1.stableStringify)(objB));
...
describe('computeAgentCommission logic', () => {
    it('computes percentage commission correctly', () => {
        ...
        const commission = (0, route_helpers_1.computeAgentCommission)(mockAgent, baseRate, totalPaid);
